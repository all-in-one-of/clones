...
namespace NewtonVR {
  public class NVRLetterSpinner : NVRInteractableRotator {
    private static readonly string LETTERLIST = "ABCDEFGHIJKLMNOPQRSTUVWXYZ?";
    ...
    protected override void Awake() {
      ...
      RungAngleInterval = 360f / LETTERLIST.Length;
    }
    ...
    public string GetLetter() {
      ...
      if (transform.localEulerAngles.z < 0.3) closest = LETTERLIST.Length - closest;

      if (closest == 27) //hack
        closest = 0;
      if (closest == -1) closest = 26;
