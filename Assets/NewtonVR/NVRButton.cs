...
namespace NewtonVR {
  public class NVRButton : MonoBehaviour {
    ...
    [Tooltip(
      "Is set to true when the button has been released from the down position this update frame")] public bool ButtonUp;
    ...
    private void Awake() {
      InitialPosition =
        new GameObject(string.Format("[{0}] Initial Position", gameObject.name)).transform;
