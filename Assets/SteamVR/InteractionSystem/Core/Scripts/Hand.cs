  ...
  public class Hand : MonoBehaviour {
    ...
    public void AttachObject(GameObject objectToAttach,
      ...
      if (currentAttachedObject) {
        currentAttachedObject.SendMessage("OnHandFocusLost", this,
          SendMessageOptions.DontRequireReceiver);
      }
    ...
    public void DetachObject(GameObject objectToDetach, bool restoreOriginalParent = true) {
      ...
      if (index != -1) {
        ...
        if (newTopObject != null && newTopObject != prevTopObject) {
          ...
          newTopObject.SendMessage("OnHandFocusAcquired", this,
            SendMessageOptions.DontRequireReceiver);
        }
      }
    ...
    private void UpdateHovering() {
      ...
      float handDiff =
        Mathf.Abs(transform.position.y - playerInstance.trackingOriginTransform.position.y);
      float boxMult =
        Util.RemapNumberClamped(handDiff, 0.0f, 0.5f * flHoverRadiusScale, 5.0f, 1.0f) *
        flHoverRadiusScale;
      ...
      Physics.OverlapBoxNonAlloc(
        ...
        new Vector3(flScaledSphereRadius, flScaledSphereRadius * boxMult * 2.0f,
      ...
      if (noSteamVRFallbackCamera) {
        ...
        if (attachedObjects.Count > 0) {
          ...
          if (Physics.Raycast(ray, out raycastHit, noSteamVRFallbackMaxDistanceNoItem)) {
            ...
            noSteamVRFallbackInteractorDistance = Mathf.Min(noSteamVRFallbackMaxDistanceNoItem,
              raycastHit.distance);
    ...
    private void Update() {
      ...
      if (hoveringInteractable) {
        hoveringInteractable.SendMessage("HandHoverUpdate", this,
          SendMessageOptions.DontRequireReceiver);
      }
    }
