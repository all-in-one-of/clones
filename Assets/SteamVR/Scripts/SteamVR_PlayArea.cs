...
public class SteamVR_PlayArea : MonoBehaviour {
  ...
  public void BuildMesh() {
    ...
    var triangles = new[] {0, 4, 1, 1, 4, 5, 1, 5, 2, 2, 5, 6, 2, 6, 3, 3, 6, 7, 3, 7, 0, 0, 7, 4};

    var uv = new[] {
      new Vector2(0.0f, 0.0f), new Vector2(1.0f, 0.0f), new Vector2(0.0f, 0.0f), new Vector2(1.0f, 0.0f),
      new Vector2(0.0f, 1.0f), new Vector2(1.0f, 1.0f), new Vector2(0.0f, 1.0f), new Vector2(1.0f, 1.0f)
    };

    var colors = new[] {
      color, color, color, color, new Color(color.r, color.g, color.b, 0.0f),
      new Color(color.r, color.g, color.b, 0.0f), new Color(color.r, color.g, color.b, 0.0f),
